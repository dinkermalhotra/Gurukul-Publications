...
class PaymentViewController: UIViewController {
    ...
    func setupUI()
    {
        ...
        self.etNameSchParty.text = params["school_name"] as? String ?? ""
        self.etEmail.text = params["sch_email"] as? String ?? ""
        self.etMobile.text = params["sch_mobile"] as? String ?? ""
    }
    ...
    func pushToOtpVC()
    {
        ...
        if(self.btnSubmit.currentTitle == "SUBMIT"){
            ...
            params["payment_mode"] = self.payment_mode as AnyObject
            params["cheque_no"] = self.chequenoText.text as AnyObject
            params["payment_price"] = self.amountTxt.text as AnyObject
            params["not_received_reason"] = self.reasonTxt.text as AnyObject
            params["cheque_price"] = self.checkamountTxt.text as AnyObject
    ...
    func sendOTP(){
        ...
        WebServices.send_otp_toMerchant(params,sellerID: user_id,amount: totalPrice,name: self.etNameSchParty.text ?? "") { isSuccess, message, otpResponse, userStatus in
            ...
            if(userStatus){
                ...
                print(otpResponse)
                let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: STORYBOARDS_ID.OTP_VC) as! OTPViewController
